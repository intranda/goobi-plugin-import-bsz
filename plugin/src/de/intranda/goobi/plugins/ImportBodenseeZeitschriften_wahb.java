...
@Log4j
public class ImportBodenseeZeitschriften_wahb implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "wahb";
	private static final String ppn = "407569901";
	private static final String title = "Westallgäuer Heimatblätter";
