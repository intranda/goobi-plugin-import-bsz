...
@Log4j
public class ImportBodenseeZeitschriften_vora implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "vora";
	private static final String ppn = "488523486";
	private static final String title = "Vorarlberg. Eine Vierteljahreszeitschrift";
