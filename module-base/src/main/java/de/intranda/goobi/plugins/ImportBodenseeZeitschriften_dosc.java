...
@Log4j
public class ImportBodenseeZeitschriften_dosc implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "dosc";
	private static final String ppn = "407475915";
	private static final String title = "Dornbirner Schriften – Beiträge zur Stadtkunde";
