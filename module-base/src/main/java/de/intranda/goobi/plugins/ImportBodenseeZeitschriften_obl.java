...
@Log4j
public class ImportBodenseeZeitschriften_obl implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "obl";
	private static final String ppn = "407685928";
	private static final String title = "Oberberger Blätter";
