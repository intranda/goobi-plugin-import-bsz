...
@Log4j
public class ImportBodenseeZeitschriften_vool implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "vool";
	private static final String ppn = "407601430";
	private static final String title = "Vorarlberger Oberland";
