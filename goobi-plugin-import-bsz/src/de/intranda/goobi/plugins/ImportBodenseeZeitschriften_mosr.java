...
@Log4j
public class ImportBodenseeZeitschriften_mosr implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "mosr";
	private static final String ppn = "407680497";
