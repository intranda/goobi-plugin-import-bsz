...
@Log4j
public class ImportBodenseeZeitschriften_tann implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "tann";
	private static final String ppn = "407596828";
	private static final String title = "Toggenburger Annalen";
