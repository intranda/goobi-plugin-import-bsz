...
@Log4j
public class ImportBodenseeZeitschriften_wbjb implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "wbjb";
	private static final String ppn = "407473181";
	private static final String title = "Werdenberger Jahrbuch";
