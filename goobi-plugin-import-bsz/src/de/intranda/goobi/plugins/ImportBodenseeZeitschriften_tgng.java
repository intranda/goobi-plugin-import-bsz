...
@Log4j
public class ImportBodenseeZeitschriften_tgng implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "tgng";
	private static final String ppn = "407647066";
	private static final String title = "Mitteilungen der Thurgauischen Naturforschenden Gesellschaft";
