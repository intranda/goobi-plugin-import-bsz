...
@Log4j
public class ImportBodenseeZeitschriften_alst implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "alst";
	private static final String ppn = "409932833";
	private static final String title = "Alemannia studens";
