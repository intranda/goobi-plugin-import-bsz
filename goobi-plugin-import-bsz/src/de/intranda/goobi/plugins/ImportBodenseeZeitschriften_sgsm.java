...
@Log4j
public class ImportBodenseeZeitschriften_sgsm implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "sgsm";
	private static final String ppn = "407938680";
	private static final String title = "St.Galler Schreibmappe für das Jahr";
