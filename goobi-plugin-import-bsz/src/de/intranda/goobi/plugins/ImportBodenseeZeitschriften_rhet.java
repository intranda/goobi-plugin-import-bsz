...
@Log4j
public class ImportBodenseeZeitschriften_rhet implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "rhet";
	private static final String ppn = "407605185";
	private static final String title = "Rheticus";
