...
@Log4j
public class ImportBodenseeZeitschriften_shma implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "shma";
	private static final String ppn = "408028955";
	private static final String title = "Schaffhauser Mappe";
