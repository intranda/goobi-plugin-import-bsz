...
@Log4j
public class ImportBodenseeZeitschriften_tja implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "tja";
	private static final String ppn = "407474226";
	private static final String title = "Toggenburger Jahrbuch";
