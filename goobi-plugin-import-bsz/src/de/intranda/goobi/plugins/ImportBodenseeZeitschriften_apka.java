...
@Log4j
public class ImportBodenseeZeitschriften_apka implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "apka";
	private static final String ppn = "407297863";
	private static final String title = "Appenzeller Kalender";
