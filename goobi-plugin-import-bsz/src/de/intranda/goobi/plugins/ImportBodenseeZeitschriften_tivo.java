...
@Log4j
public class ImportBodenseeZeitschriften_tivo implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "tivo";
	private static final String ppn = "407595562";
	private static final String title = "Tirol–Vorarlberg. Natur, Kunst, Volk, Leben";
