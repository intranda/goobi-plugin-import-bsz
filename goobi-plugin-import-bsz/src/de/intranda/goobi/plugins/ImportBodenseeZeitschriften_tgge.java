...
@Log4j
public class ImportBodenseeZeitschriften_tgge implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "tgge";
	private static final String ppn = "408036362";
	private static final String title = "Thurgauer Beiträge zur (vaterländischen) Geschichte";
