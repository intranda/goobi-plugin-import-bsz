...
@Log4j
public class ImportBodenseeZeitschriften_wahe implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "wahe";
	private static final String ppn = "40761933X";
	private static final String title = "Walserheimat";
