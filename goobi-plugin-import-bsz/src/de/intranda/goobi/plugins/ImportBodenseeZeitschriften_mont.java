...
@Log4j
public class ImportBodenseeZeitschriften_mont implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "mont";
	private static final String ppn = "278241670";
