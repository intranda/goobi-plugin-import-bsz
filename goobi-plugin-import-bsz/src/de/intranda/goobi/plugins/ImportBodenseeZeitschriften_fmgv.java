...
@Log4j
public class ImportBodenseeZeitschriften_fmgv implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "fmgv";
	private static final String ppn = "40801069X";
	private static final String title = "Forschungen und Mitteilungen zur Geschichte Tirols und Vorarlbergs";
