...
@Log4j
public class ImportBodenseeZeitschriften_klwa implements IImportPluginVersion2, IPlugin {
	
	private static final String BASIC_NAME = "klwa";
	private static final String ppn = "408064242";
	private static final String title = "Kleinwalsertal. Kultur, Landschaft, Fremdenverkehr";
